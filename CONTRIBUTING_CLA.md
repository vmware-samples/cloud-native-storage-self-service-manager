...
1. Update the documentation, if required.
1. Commit to your fork using a clear commit messages.
...
``` shell
git remote add upstream https://github.com/vmware-samples/cloud-native-storage-self-service-manager.git
...
discuss, [open a discussion](https://github.com/vmware-samples/cloud-native-storage-self-service-manager/discussions).
